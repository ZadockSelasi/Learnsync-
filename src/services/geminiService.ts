...
export const generateCareerRoadmap = async (careerGoal: string, profile?: any) => {
  ...
  prompt += `\n\nInclude:
  1. Required skills
  2. Beginner to advanced milestones (each with 2-3 relevant learning resources like articles, videos, or courses)
  ...
  Format the output as a JSON object with the following structure:
  {
    ...
    "milestones": [
      { 
        ...
        "resources": [
          { "title": "string", "type": "article|video|course|book", "url": "string (use a realistic or search URL)" }
        ]
      }
    ],
          ...
          properties: {
            ...
            milestones: {
              ...
              items: {
                ...
                properties: {
                  ...
                  resources: {
                    ...
                    items: {
                      ...
                      properties: {
                        title: { type: Type.STRING },
                        type: { type: Type.STRING, description: "article, video, course, book" },
                ...
                required: ["title", "description", "level", "resources"]
              }
            },
